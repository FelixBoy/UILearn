...
_3b1(_3b0(_3ae.expanest)?_3ae.expanest:_3ae.west,"w");
...
_3cf.east.add(_3cf.west).add(_3cf.expandEast).add(_3cf.expanest).panel("resize",{top:_3d9-1,height:hh});
...
_3cf.east.add(_3cf.west).add(_3cf.expandEast).add(_3cf.expanest).panel("resize",{height:hh});
