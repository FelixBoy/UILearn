...
_b(_a(_7.expanest)?_7.expanest:_7.west,"w");
...
_31.east.add(_31.west).add(_31.expandEast).add(_31.expanest).panel("resize",{top:_3d-1,height:hh});
...
_31.east.add(_31.west).add(_31.expandEast).add(_31.expanest).panel("resize",{height:hh});
